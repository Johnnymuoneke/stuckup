    ...
    return (
        <>
            <View className="flex-row gap-2">
                <View className="flex-1 border border-border bg-card p-4 rounded-3xl">
            ...
            <View className="rounded-3xl border border-border bg-card p-4">
                <View className="flex-row items-center justify-between">
                    ...
                    <Text className="text-sm font-semibold text-primary">{completedItems}%</Text>
                </View>
                <View className="mt-3 overflow-hidden bg-secondary rounded-full">
                    <View
